...
public abstract class TelNumBlockAdapter extends RecyclerView.Adapter<TelNumBlockAdapter.ViewHolder> {
    private Context mContext;
    private ArrayList<TelNumBlock> mItems;

    public TelNumBlockAdapter(Context context) {
        mContext = context;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        final TelNumBlock item = mItems.get(position);
