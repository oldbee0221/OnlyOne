...
/**
 * Created by jeonghopark on 2020/05/02.
 */
public class CBMChoiceList2Activity extends AppCompatActivity implements Constants, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgressDialog = new ProgressDialog(CBMChoiceList2Activity.this);
    }
    ...
    public void onClick(View view) {
        ...
        switch (vid) {
            case R.id.btn_write: {
                Intent i = new Intent(CBMChoiceList2Activity.this, CBMReg2Activity.class);
                startActivity(i);
            }
            break;
            ...
            case R.id.iv_menu:
                startActivity(new Intent(CBMChoiceList2Activity.this, LogActivity.class));
                break;
    ...
    private void init() {
        ...
        mAdapter = new CallMsgChoiceAdapter(mContext, mIsFromMsg, Utils.GetLongSharedPreference(mContext, PREF_CB_AUTO_MSG2)) {
            @Override
            public void load() {
                loadData();
            }
            ...
            public void onUpdate(final CallMsg item) {
                if(mIsFromMsg) {
                    Intent i = new Intent(CBMChoiceList2Activity.this, CBMUpdate2Activity.class);
                    i.putExtra(EXTRA_SND_NUM, mSndNumber);
                    i.putExtra("data", item);
                    startActivityForResult(i, REQ_UPDATE);
                } else {
                    Intent i = new Intent(CBMChoiceList2Activity.this, CBMUpdateActivity.class);
                    i.putExtra("data", item);
                    startActivity(i);
                }
            }
            ...
            public void onDel(final CallMsg item) {
                AlertDialog.Builder builder = new AlertDialog.Builder(CBMChoiceList2Activity.this);
                ...
                if (CBMChoiceList2Activity.this.isFinishing() == false) {
                    builder.show();
                }
            }
        };
