...
import mms5.onepagebook.com.onlyonesms.adapter.TelNumPermitAdapter;
...
public class CBMMgr2Fragment extends BaseFragment implements View.OnClickListener {
    private SwipeRefreshLayout mSrl;
    private RecyclerView mRv;
    private LinearLayoutManager mLayoutManager;
    private TelNumPermitAdapter mAdapter;

    private List<TelNumPermit> mNums;

    public static CBMMgr2Fragment create() {
        CBMMgr2Fragment fragment = new CBMMgr2Fragment();
        return fragment;
    }
    ...
    private void init() {
        ...
        mAdapter = new TelNumPermitAdapter(mContext) {
            @Override
            public void load() {
                loadData();
            }
            ...
            @Override
            public void onDel(final TelNumPermit item) {
                ...
                builder.setPositiveButton(getString(R.string.delete), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int arg1) {
                        new Thread(new Runnable() {
                            @Override
                            public void run() {
                                AppDatabase.getInstance(mContext).getTelNumPermitDao().delete(item);
