package mms5.onepagebook.com.onlyonesms.deprecated;
...
import mms5.onepagebook.com.onlyonesms.LogActivity;
...
public class LogInActivity extends AppCompatActivity implements Constants {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_log_in_deprecated);
        ...
        if (requestCode == REQUEST_PERMISSION) {
            for (int grantResult : grantResults) {
                if (grantResult != PackageManager.PERMISSION_GRANTED) {
                    Toast.makeText(getApplicationContext(), "Please allow permissions.(4)", Toast.LENGTH_SHORT).show();
                    finish();
                    return;
                }
            }
