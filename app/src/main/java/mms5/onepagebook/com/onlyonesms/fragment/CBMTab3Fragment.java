...
public class CBMTab3Fragment extends BaseFragment implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public static CBMTab3Fragment create() {
        CBMTab3Fragment fragment = new CBMTab3Fragment();
        return fragment;
    }
    ...
    public void onClick(View view) {
        ...
        switch (vid) {
            case R.id.btn_reg: {
                ...
                intent.putExtra(Constants.EXTRA_CB_MSGTYPE, "발신");
